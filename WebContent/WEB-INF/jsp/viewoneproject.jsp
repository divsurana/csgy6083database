...
<div id="table">
    ...
    <span class="cell">Like</span>
    <span class="cell">Number of likes</span>
    <span class="cell">Pledge</span>
  </div>
  <div class="row">
    ...
    <span class="cell" data-label="Trans">5 Speed</span>
		<span class="cell" data-label="Trans">5 Speed</span>
    <span class="cell"><button id="button"  onclick="like()">Like</button></span>
    <span class="cell"><p type="text" id="show" style="color:orange;"></p></span>
    <span class="cell"><form action="postapledge.html">
...
<div id="table">
  ...
  <div class="row">
    ...
    <span class="cell primary" data-label="Vehicle">2013 Subaru WRX</span>
    <span class="cell" data-label="Exterior">World Rally Blue</span>
     <span class="cell" data-label="Interior">DateTime</span>
  </div>
